    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="?pid=<?php echo base64_encode('presentacion/Piloto/misVuelos.php'); ?>">
                        <i class="fa-solid fa-plane me-1"></i> Mis Vuelos
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="?pid=<?php echo base64_encode('presentacion/Piloto/historialVuelos.php'); ?>">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                        <li>
                            <a class="dropdown-item" href="?pid=<?php echo base64_encode('presentacion/Piloto/editarPerfil.php'); ?>">
                                <i class="fa-solid fa-user-pen me-2"></i> Editar Perfil
                            </a>
                        </li>

                        <li>
                            <a class="dropdown-item" href="?pid=<?php echo base64_encode('presentacion/Piloto/miLicencia.php'); ?>">
                                <i class="fa-solid fa-id-card me-2"></i> Mi Licencia
                            </a>
                        </li>
